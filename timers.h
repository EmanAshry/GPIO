...
typedef struct TIM_Config{
  ...
  uint8_t Timer_Comp_Value;
  uint8_t Timer_Interrupt;
  uint8_t Timer_Assync;         //Timer2

}TIM_Config;

typedef struct TIM_Config_16bit{

  uint16_t Timer_Mode;
  uint16_t Timer_OC;
  uint16_t Timer_Pre;
  uint16_t Timer_Init_Value;
  uint16_t Timer_OComp_A;
  uint16_t Timer_OComp_B;
  uint16_t Timer_ICU;
  uint16_t Timer_Interrupt;

}TIM_Config_16bit;

static TIM_Config Timer_Config;
static TIM_Config_16bit Timer_Config_16bit;
